...
class Settings:
    ...
    AWS_SES_REGION = _get("AWS_SES_REGION")
    AWS_SES_ACCESS_KEY_ID = _get("AWS_SES_ACCESS_KEY_ID")
    AWS_SES_SECRET_ACCESS_KEY = _get("AWS_SES_SECRET_ACCESS_KEY")
    AWS_SES_CONFIGURATION_SET = _get("AWS_SES_CONFIGURATION_SET")
